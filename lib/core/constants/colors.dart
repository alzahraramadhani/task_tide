...
class AppColors {
  ...
  static const Color background = Color(0xFFFAFAFA);      // Off-White Latar Belakang
  ...
  static const Color progressBackground = Color(0xFFE8EAF6); // Latar Belakang Progress Bar
  ...
  static const List<Color> pastelPalette = [
    Color(0xFFFFF3E0), // Oranye Pastel (Kuliah/Tugas)
    Color(0xFFEDE7F6), // Ungu Pastel (Praktikum)
    Color(0xFFE8F5E9), // Hijau Pastel (Organisasi)
